...
from strand_cost_guard.core.entities import PeriodUsage, RunState
from strand_cost_guard.policies.budget import BudgetPeriod, BudgetScope, BudgetSpec
...
class BudgetTracker:
    ...
    Maintains in-memory counters for fast access, with optional persistence.
    """
